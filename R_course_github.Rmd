...
To look at this relationship I will use soil storage from konza pulse station 2 in conjunction with a metric from my STIC data called wet network proportion. This is the percentage of the total number of sensors showing a wet reading at each timestep, which I will calulate from my `stic_files` data frame above.
