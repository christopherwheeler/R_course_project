...
Moving on from tests for normality, I want to use the Rosner test to idenitfy potential outliers, and see generally tracks with the appearence of the nitrate boxplots 
